...
if(!isNil {player getVariable "_sellingVehicle"}) exitWith {closeDialog 0};
player setVariable ["_sellingVehicle",true];
[] spawn
{
	sleep 5;
	player setVariable ["_sellingVehicle",nil];
};
